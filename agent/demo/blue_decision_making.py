...
class DemoDecision():
    ...
    def init_move(self, cmd_list):
        ...
        if self.side == -1:
            cmd_list.append(
                env_cmd.make_linepatrolparam(self.first_formation["leader_plane"].ID, [{"X": 25000 * self.side, "Y": -75000, "Z": 9500}], 250, 1.0, 3))
            cmd_list.append(
                env_cmd.make_linepatrolparam(self.sec_formation["leader_plane"].ID,
                                             [{"X": 25000 * self.side, "Y": 0, "Z": 9500}], 250, 1.0, 3))
            cmd_list.append(
                env_cmd.make_linepatrolparam(self.sec_formation["uav_1"].ID, [{"X": 30000 * self.side, "Y": -37500, "Z": 9500}], 150, 1.0, 3))

            destination = [{'X': 150000, 'Y': 400, 'Z': 2000}, {'X': 150000, 'Y': 500, 'Z': 3000}]
            cmd_list.append(
                env_cmd.make_linepatrolparam(self.first_formation["up_plane"].ID, destination, 250, 1.0, 3))
            cmd_list.append(
                env_cmd.make_linepatrolparam(self.first_formation["down_plane"].ID, destination, 250, 1.0, 3))
            cmd_list.append(
                env_cmd.make_linepatrolparam(self.first_formation["uav_2"].ID, destination, 250, 1.0, 3))
            cmd_list.append(
                env_cmd.make_linepatrolparam(self.sec_formation["up_plane"].ID, destination, 250, 1.0, 3))
            cmd_list.append(
                env_cmd.make_linepatrolparam(self.sec_formation["down_plane"].ID, destination, 250, 1.0, 3))
            cmd_list.append(
                env_cmd.make_linepatrolparam(self.first_formation["uav_1"].ID, destination, 250, 1.0, 3))
            cmd_list.append(
                env_cmd.make_linepatrolparam(self.sec_formation["uav_2"].ID, destination, 250, 1.0, 3))
